...
* Proficiency in frameworks like React, NestJS, Next.js, Flask, Vue and Express.
* Looking for work as a junior fullstack engineer in any of my proficient languages.
* Spanish (native) and English (C1 advanced)
* I am currently doing a bootcamp at [Boot.dev](https://www.boot.dev) to increase my general programming skllsC.
